...
public class StoreData {
	public static void main(String[] args)
	{
		...
		List<String> s1 =Arrays.asList("Java","Spring","MultiSkill");
		std1.setSkills(s1);
		
		Student std2 = new Student();
		std2.setName("Virat");
		std2.setStd_college("MU");
		List<String> s2 =Arrays.asList("MicroServices","Cloud","AI","Talented");
		std2.setSkills(s2);
		...
		while(itr.hasNext())
		{
			...
			System.out.println(std.getId()+" "+std.getName()+" "+std.getStd_college()+" "+std.getStd_college());
